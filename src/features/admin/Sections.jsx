                ...
                <>
                    ...
                    >
                        ...
                        >
                            ...
                            {t("admin.admin_panel.main_page.sections.food_shipping.headline")}
                            </span>
                    ...
                    >
                        ...
                        >
                            <span className="text-center text-xl font-bold">
                                {t("admin.admin_panel.main_page.sections.edit_menu.headline")}
                            </span>
                            <div className="relative" style={{ flex: "1" }}>
                                <img
                                    style={{
    ...
    return (
        ...
        >
            ...
            >
                {orderCounts && 
                    <div
                        className="absolute flex flex-col gap-2 rounded-md right-2 top-4 px-2 py-4"
                        style={{ zIndex: 30, background: "#a8a8a89c" }}
                    >
                        <div
                            className="rounded-full  flex items-center justify-center text-white"
                            style={{ height: 30, width: 30, background: "#ef4444" }}
                        >
                            {orderCounts[orderStatuses.notHandled]}
                        </div>
                        <div
                            className="rounded-full flex items-center justify-center text-white"
                            style={{ height: 30, width: 30, background: "#eab308" }}
                        >
                            {orderCounts[orderStatuses.handled]}
                        </div>
                        <div
                            className="rounded-full flex items-center justify-center text-white"
                            style={{ height: 30, width: 30, background: "#fb923c" }}
                        >
                            {orderCounts[orderStatuses.preparing]}
                        </div>
                        <div
                            className="rounded-full flex items-center justify-center text-white"
                            style={{ height: 30, width: 30, background: "#059669" }}
                        >
