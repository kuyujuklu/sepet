                ...
                <div className="content m-auto">
                    ...
                    <section className="max-w-6xl m-auto my-20 md:my-20 p-2 ">
                        <div className="md:flex justify-evenly bg-white rounded-xl md:bg-transparent">
                            <div className="left  md:w-1/2 p-2 ">
                                ...
                                <p className="description p-4">
                                    ...
                                    <ul className="p-4 m-2">
                                        ...
                                        <li className="mb-6">Администратов следит за качеством и скоростью приготовления и доставки заказов...</li>
                                    </ul>
                            ...
                            <div className="right md:w-1/2 p-2">
                                <img alt="Обзор продукта QR menu" className="m-auto border rounded-2xl shadow-2xl"
                    ...
                    <section className="max-w-6xl m-auto my-36 p-2 ">
                        <div className=" md:flex justify-evenly bg-white rounded-xl">
                            ...
                            <div className="1/2part md:w-1/2 p-2" >
                                <img alt="Показано рабочее место команты Sandex" className="m-auto p-4 md:relative -z-1 -top-16 border rounded-2xl shadow-2xl"
                    ...
                    <section className="max-w-6xl m-auto my-20 md:my-20 p-2 ">
                        <div className="md:flex justify-evenly bg-white rounded-xl md:bg-transparent">
                            <div className="right md:w-1/2 p-2 ">
                                <img alt="Показаны инструменты разработки команды сандекс" className="m-auto border rounded-2xl shadow-2xl"
                    ...
                    <section className="max-w-6xl m-auto my-20 md:my-20 p-2 ">
                        <div className="md:flex justify-evenly bg-white rounded-xl md:bg-transparent">
                            ...
                            <div className="right md:w-1/2">
                                <img alt="Показано рабочее место дизайнера проекта" className="md:p-4 m-auto border rounded-2xl shadow-2xl"
                        ...
                        <div className=" md:flex justify-evenly bg-white rounded-xl">
                            <div className="1/2part md:w-1/2 p-2">
                                <div className="relative -z-1 -top-36">
                                    <img alt="Много функциональный офис" className="p-4 m-auto rounded-2xl border" src="/images/png/optimization_admin.png"></img>
                    ...
                    {/* <!-- seven thin block  --> */}
                    <section className="hidden max-w-6xl m-auto my-20 md:my-20 p-2 ">
                        <div className="text-center">
                            <div className="headWide my-2  text-6xl">Отзывы</div>
                            <div className="slogan my-2 ">Лучшая мотивация для нас это наши довольные клиенты</div>
                    ...
                    <section className="hidden max-w-6xl m-auto my-20 md:my-20 p-2">
                        <div className="justify-evenly lg:flex">
                            <div
                                className="flex flex-col justify-between mb-8 py-16 p-10 m-2 bg-white rounded-xl text-center lg:w-1/3">
                                <div className="my-4 review-text-xl font-semibold">Очень доволен молодой командой.
                                    Продукт сделан качественно и со вкусом</div>
                                <div>
                                    <div className="review_stars flex ">
                                        <img className="my-4 mx-auto rates h-12 w-12 " src=""
                                            alt="* * * * *"></img>
                                        <img className="my-4 mx-auto rates h-12 w-12 " src=""
                                            alt="* * * * *"></img>
                                        <img className="my-4 mx-auto rates h-12 w-12 " src=""
                                    ...
                                    <h2 className="my-4 person text-2xl font-semibold">Влад Саров</h2>
                                    <div className="my-4 position">CEO</div>
                                </div>
                            </div>
                            <div
                                className="flex flex-col justify-between mb-8 py-16 p-10 m-2 bg-white rounded-xl text-center lg:w-1/3">
                                <div className="my-4 review-text-xl font-semibold">Начали делать простой лэндинг для
                                    продвижения. В итоге сделали анализ что нужно веб приложение для взаимодествия с
                                    клиентами. Быстро соорентировались и добавили нужный функционал. Всем очень
                                    доволен.</div>
                                <div>
                                    <div className="review_stars flex ">
                                        <img className="my-4 mx-auto rates h-12 w-12 " src=""
                                    ...
                                    <h2 className="my-4 person text-2xl font-semibold">Igor Vlah</h2>
                                    <div className="my-4 position">Product Manager</div>
                                </div>
                            </div>
                            <div
                                className="flex flex-col justify-between mb-8 py-16 p-10 m-2 bg-white rounded-xl text-center lg:w-1/3">
                                <div className="my-4 review-text-xl font-semibold">Ребята подробно объясняют все детали
                                    и какого ждать рузультата, только после этого начинают реализацию. Все очень
                                    прозрачно</div>
                                <div>
                                    <div className="review_stars flex ">
                                        <img className="my-4 mx-auto rates h-12 w-12 " src=""
                                    ...
                                    <h2 className="my-4 person text-2xl font-semibold">Dorin V.</h2>
                                    <div className="my-4 position">Владелец ресторана</div>
                                </div>
                            </div>
                        </div>
                    </section>
