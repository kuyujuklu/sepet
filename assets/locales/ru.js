export default {
  ...
  pub_not_available_for_delivery: {
    ...
    pub_is_not_open: "Вы находитесь вне зоны доставки этого заведения",
    choose_another_pub: "Выбрать другое заведение",
    change_geolocation: "Изменить местоположение",
    closed_toast: "Заведение сейчас закрыто, но вы можете собрать корзину или оформить предзаказ в рабочее время"
  },
  version: {
