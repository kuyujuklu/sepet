export default {
  ...
  select_geolocation: {
    ...
    detecting_address: "Determinăm adresa…",
  ...
  notifications_page: {
    title: "Notificări",
    empty: "Deocamdată nu sunt notificări",
  ...
  home_page: {
    ...
    top_dishes: {
      ...
      deals_title: "Oferte fierbinți",
      deals_subtitle: "Am adunat pentru tine cele mai avantajoase poziții",
      filter_top: "Populare",
      filter_deals: "Reduceri",
      filter_pubs: "Localuri",
      filters_button: "Filtrează",
      filters_sheet_subtitle: "Categorie sau condiții de livrare",
      filters_delivery_group: "Livrare",
      filter_free_delivery: "Livrare gratuită",
      sort_button: "Sortează",
      sort_sheet_title: "Sortează",
      sort_rating: "După rating",
      sort_distance: "După distanță",
      sort_speed: "După viteza de livrare",
      search_placeholder: "Caută preparate",
      search_cancel: "Anulează",
      search_prompt: "Începeți să scrieți pentru a găsi un preparat",
      search_no_results: "Nu s-a găsit nimic",
  ...
  create_order_page: {
    address: {
      ...
      save_toggle: "Salvați adresa pentru comenzile viitoare",
    },
    contacts: {
      title: "Contacte",
    },
